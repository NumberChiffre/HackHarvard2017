...
class RNN():
    ...
    def splitTrainTestData(self, datasetNorm):
        ...
        xTrain, yTrain = datasetTrain[['Ratio', 'Volume', 'compound', 'neu', 'neg', 'pos']].as_matrix(), datasetTrain['Closing'].as_matrix()
        xTest, yTest = datasetTest[['Ratio', 'Volume', 'compound', 'neu', 'neg', 'pos']].as_matrix(), datasetTest['Closing'].as_matrix()     
...
if __name__ == "__main__":
    rnn = RNN(num_epochs=2000, num_features=6)
